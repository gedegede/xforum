    ...
    <div class="post-header justify-between">
        <div class="flex items-center gap-md">
            <div class="avatar avatar-post">
                <?php if (!empty($users[$post['uid']]['avatar'])): ?>
                    <img src="<?php echo htmlspecialchars($users[$post['uid']]['avatar']); ?>" alt="">
                <?php else: ?>
            ...
            <div class="flex-1 min-width-0">
                <div class="flex items-center gap-md">
                    <span class="font-bold"><?php echo htmlspecialchars($users[$post['uid']]['username'] ?? '已删除用户'); ?></span>
                    <?php if ($isFirst): ?>
        ...
        <div class="flex items-center gap-md">
            <button type="button" class="btn btn-ghost text-muted" aria-label="喜欢">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                </svg>
            </button>
            <button type="button" class="btn btn-ghost text-muted quote-btn" aria-label="引用回复" data-pid="<?php echo $post['pid']; ?>" data-uid="<?php echo $post['uid']; ?>" data-floor="<?php echo $index; ?>" data-username="<?php echo htmlspecialchars($users[$post['uid']]['username'] ?? ''); ?>">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
