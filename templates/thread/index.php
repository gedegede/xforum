            ...
            <div class="section">
                ...
                <div class="row justify-between">
                    ...
                    <?php if (isset($template_user)): ?>
                        <button type="button" id="fav-btn-mobile" class="btn <?php echo $template_isFavorited ? 'btn-secondary' : 'btn-primary'; ?>" data-tid="<?php echo $template_thread['tid']; ?>" data-favorited="<?php echo $template_isFavorited ? '1' : '0'; ?>">
                ...
                <div class="panel">
                    <?php if (isset($template_user)): ?>
                        <form id="reply-form" action="index.php?c=thread&a=reply&tid=<?php echo $template_thread['tid']; ?>" method="post">
                            ...
                            <textarea name="message" id="reply-message" placeholder="支持 Markdown 语法，欢迎补充细节、经验与上下文..."></textarea>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function addReplyToPage(html, postIndex) {
                ...
                const existingPosts = document.querySelectorAll('.entry');
                ...
                if (newPost) {
                    ...
                    newPost.style.backgroundColor = 'var(--hover)';
                    setTimeout(() => {
