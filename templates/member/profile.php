...
<div class="card">
 ...
 <a href="index.php?c=thread&a=index&tid=<?php echo $post['tid']; ?>&pid=<?php echo $post['pid']; ?>" class="list-item">
 <div class="flex-1 min-width-0">
 <div class="font-bold">
 ...
 <<?php echo $creditUrl !== '' ? 'a href="' . htmlspecialchars($creditUrl) . '"' : 'div'; ?> class="list-item">
 <div class="flex-1 min-width-0">
 <div class="font-bold">
 ...
 <div class="font-bold <?php echo $creditValue >= 0 ? 'is-plus' : 'is-minus'; ?>">
