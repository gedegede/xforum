...
<head>
    ...
    ?>
        <style id="user-custom-css">
            <?php echo str_ireplace('</style', '<\\/style', $customCss); ?>
        </style>
    <?php endif; ?>
    ...
    <footer class="hide-mobile mt-1">
        ...
        <div class="container p-4 px-3">
            ...
            ?>
                ...
                <h4 class="mb-3 text-sm font-semibold">SQL查询日志 (共 <?php echo count($queryLog); ?> 条)</h4>
                <?php foreach ($queryLog as $index => $query): ?>
                    <div class="card mb-2">
                        <div class="card-body mb-4 bg-gray-50 rounded">
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <span class="text-sm"><?php echo number_format($query['duration'], 2); ?>ms</span>
                            </div>
                            <div>
                            ...
                            <?php if (!empty($query['explain'])): ?>
                                <div class="text-sm mt-2">EXPLAIN:</div>
                                <div class="table-wrap text-sm">
                                    <table>
                                        <thead class="text-muted text-left bg-panel">
                                            <tr>
                                            ...
                                            <?php foreach ($query['explain'] as $row): ?>
                                                <tr>
                                                    <?php foreach ($row as $val): ?>
                                                        <td class="bg-soft p-2"><?php echo htmlspecialchars((string)($val ?? '-')); ?></td>
                                                    <?php endforeach; ?>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
