        ...
        <form method="post">
            ...
            <div class="mb-8">
                ...
                <div class="flex flex-col lg:flex-row gap-6 mb-6">
                    ...
                    <div class="lg:w-80">
                        <textarea id="setting_approve_keywords" name="setting_approve_keywords" class="w-full h-control px-3 border border-border rounded bg-panel text-text text-base transition-colors focus:outline-none focus:border-primary w-full" rows="5" placeholder="例如：&#10;敏感词一&#10;敏感词二"><?php echo htmlspecialchars($template_settings['approve_keywords'] ?? ''); ?></textarea>
                    </div>
                </div>
                ...
                <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <div class="lg:w-80">
                        <textarea id="setting_block_keywords" name="setting_block_keywords" class="w-full h-control px-3 border border-border rounded bg-panel text-text text-base transition-colors focus:outline-none focus:border-primary w-full" rows="5" placeholder="例如：&#10;广告词一&#10;广告词二"><?php echo htmlspecialchars($template_settings['block_keywords'] ?? ''); ?></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <div class="lg:w-80">
                        <div class="border rounded-lg overflow-hidden">
                            ...
                            ?>
                            <div class="flex items-center px-3 py-2 border-t border-border">
                                <div class="flex-1 min-w-0">
                                    <strong class="text-sm"><?php echo htmlspecialchars($label); ?></strong>
                                    <span class="text-xs text-muted ml-2"><?php echo htmlspecialchars($action); ?></span>
                                </div>
