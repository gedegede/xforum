...
$tables = [
    ...
    'next_member' => "CREATE TABLE `next_member` (
        ...
        `avatar` INTEGER UNSIGNED NOT NULL DEFAULT 0,
...
$db->exec("INSERT INTO `next_member` (`uid`, `username`, `gid`, `password`, `auth_secret`, `reg_ip`, `reg_date`, `status`, `json_data`) VALUES (1, 'admin', 1, '" . password_hash('admin123', PASSWORD_DEFAULT) . "', '" . md5(uniqid()) . "', '127.0.0.1', " . time() . ", 1, '{}')");
